...
const articleImages = {
  ...
  kranen: {
    ...
    alt: "Aerial view of the Maasvlakte, with wind turbines along the sea defence and container terminals",
    width: 1672,
    height: 941,
  },
  scan: {
  ...
  kering: {
    ...
    alt: "The closed Maeslantkering storm surge barrier at Hoek van Holland, sealing the Nieuwe Waterweg from the sea",
    width: 1535,
    height: 1024,
  },
} as const;
