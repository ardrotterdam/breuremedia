...
const articleImages = {
  hero: {
    ...
    alt: "Containerkräne im Hafen von Rotterdam in der Dämmerung, mit einem Seeschiff am Kai an der Nieuwe Maas",
    width: 1672,
    height: 941,
  },
  kranen: {
  ...
  scan: {
    ...
    alt: "Ein Seecontainer passiert einen Röntgenscanner des Zolls im Hafen von Rotterdam",
    width: 1672,
    height: 941,
  },
  kering: {
